...
public class DbService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "wesleyikiko@hotmail.com", "36378912377", TipoCliente.PESSOAFISICA,pe.encode("123"));

		Cliente cli2 = new Cliente(null, "Ana Maria", "wesleyokiko@hotmail.com", "08995024666", TipoCliente.PESSOAFISICA,pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		
		cli1.getTelefones().addAll(Arrays.asList("27363323", "9383839453"));
		cli2.getTelefones().addAll(Arrays.asList("2736312123", "938383915"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Maria Moreira", "105", "Sala 800", "JD Azaléias", "37750000", cli2, c2);
